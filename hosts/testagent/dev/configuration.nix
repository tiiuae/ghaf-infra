...
}:
{
  ...
  services.udev.extraRules = ''
    ...
    # Orin AGX1
    SUBSYSTEM=="tty", KERNEL=="ttyACM[0-9]*", ATTRS{serial}=="TOPO49C47447", ENV{ID_USB_INTERFACE_NUM}=="01", SYMLINK+="ttyAGX1", MODE="0666", GROUP="dialout"
    # SSD-drive
  ...
  environment.etc."jenkins/test_config.json".text =
    ...
    builtins.toJSON {
      addresses = {
        ...
        OrinAGX64 = {
          inherit location;
          device_id = "00-9f-d1-76-87";
          netvm_hostname = "ghaf-2681304711";
          relay_number = 1;
        ...
        DarterPRO = {
          inherit location;
          device_id = "00-c1-97-41-c8";
          netvm_hostname = "ghaf-3247915464";
          serial_port = "/dev/ttyDARTER";
          device_ip_address = "172.18.16.52";
          socket_ip_address = "NONE";
          plug_type = "NONE";
          switch_bot = "DarterPRO-dev";
