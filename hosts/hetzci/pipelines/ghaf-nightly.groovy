...
def TARGETS = [
  ...
  [ target: "packages.x86_64-linux.lenovo-x1-carbon-gen11-debug",
    testset: '_relayboot_gui_regression_', uefisign: true, uefitest: true, sbom: true,
  ],
  [ target: "packages.x86_64-linux.lenovo-x1-carbon-gen11-debug-installer",
    testset: '_relayboot_gui_regression_', uefisigniso: true, sbom: true,
  ],
  ...
  [ target: "packages.x86_64-linux.system76-darp11-b-debug",
    testset: '_relayboot_gui_regression_', uefisign: true, sbom: true,
  ],
