...
pipeline {
  ...
  stages {
    ...
    stage('Image download') {
      steps {
        script {
          ...
          def use_ghaf_flash = params.FLASH_CACHE_URL && params.FLASH_STORE_PATH
          if (use_ghaf_flash) {
    ...
    stage('Flash') {
      steps {
        // Ghaf flash-script is used when FLASH_CACHE_URL and FLASH_STORE_PATH
        // are provided; otherwise falls back to legacy inline dd:
        script {
