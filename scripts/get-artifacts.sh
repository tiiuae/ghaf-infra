...
usage() {
  cat <<EOF
Usage: $MYNAME [-h] [-v] [-o OUTDIR] -u URL

Recursively fetch URL to a local directory (OUTDIR)


Options:
 -h    Print this help message
 -v    Set the script verbosity to DEBUG
 -o    Set the script output directory to OUTDIR (default: ./$OUTDIR)
 -u    Target URL to recursively download

Example:

  ./$MYNAME -u https://ghaf-jenkins-controller-dev.azure.com/path/to/artifact/
