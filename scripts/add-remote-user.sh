...
Options:
 ...
 -u    Username to be added to the remote host (default=\$USER)'
 -s    SSH options used for the initial login to the remote host
 -k    Path to the public key that will be added to remote USER's authorized_keys
...
add_remote_user() {
  ...
  if ! ssh $OPT_s "\
        sudo sort -u /home/$OPT_u/.ssh/authorized_keys -o /home/$OPT_u/.ssh/authorized_keys;"; then
